...
GitHub Pages y una futura APK no deben contener el token del bot. La versión 2.2.0 incluye una Supabase Edge Function en `supabase/functions/telegram/index.ts`.
